...
function exportToExcel(allocations, metadata = {}) {
    console.log("exportToExcel called with allocations:", allocations);
    console.log("exportToExcel metadata:", metadata);
    ...
    try {
        ...
        const wsData1 = [];
        wsData1.push(["Śrī Viṣṇu Sahasranāma - Satsang Allocation Report"]);
        wsData1.push([]);
        wsData1.push([
        ...
        // Add fixed single assignments at top - with random selection
        for (const segment of ["Starting Prayer", "Śrī Mahālakṣmī Aṣṭakam", "Kṣamā Prārthanā & Ending Prayer"]) {
        ...
        const wsData2 = [];
        wsData2.push(["Śrī Viṣṇu Sahasranāma - Satsang Allocation Report"]);
        wsData2.push([]);
        wsData2.push([
            `Batch Name: ${metadata.batchNumber || ''}`,
            `Satsang #: ${metadata.satsangNo || '1'}`,
